  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <ComboboxButton className="absolute inset-y-0 right-0 flex items-center px-3 text-slate-400 active:bg-slate-100 rounded-r">
          ...
          {filtered.length === 0 && query !== '' ? (
            ...
            filtered.map(o => (
              <ComboboxOption
                key={o.value}
                value={o.value}
                className="data-[focus]:bg-slate-100 active:bg-slate-200 px-3 py-3 cursor-pointer"
              >
                {o.label}
              </ComboboxOption>
            ))
